...
const pro4="green.png";

const Project = () => {
  return (
    <Box  width={"100%"}  >
      <Box ><Text fontSize="35px" textDecoration={"underline"} fontWeight="bold" mb="30px" color={"#cf3c58"}  >Projects</Text></Box>

<SimpleGrid columns={[1,1,1,2,2]} w={{base:"85%"}} m="auto" gap="20px">

<Box boxShadow="rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"   borderRadius="15px" backgroundColor= "rgb(247, 232, 232)">
...
<Box boxShadow="rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"   borderRadius="15px" backgroundColor= "rgb(247, 232, 232)">
  <Image borderTopRightRadius={"15px"} borderTopLeftRadius={"15px"} h="250px" w="100%" src={pro4} alt="" />
  <Box mt="10px" mb="10px" ><Text fontWeight="bold">Greenhouse-Clone</Text></Box>
  <Box padding={"10px"} textAlign="center">
Sourcing Automation helps you find, reach and engage top talent quickly and effectively. Easily capture your prospects' contact information, personalize and scale your outreach and automate communication – all with Greenhouse.
</Box>
  <Box >
...
<Box display="flex"justifyContent="space-around" alignItems="center" mt="5px" mb="5px" >
  <Flex gap="20px" alignItems="center">
    <Box ><a href='https://github.com/Swati863/GreenHouse' target="_blank" rel="noreferrer" ><Button  variant="unstyled"><FaGithub fontSize={"25px"}/></Button></a></Box>
    <Box ><a href=' https://green-house-kappa.vercel.app/' target="_blank" rel="noreferrer" ><Button  variant="unstyled">Go live</Button></a></Box>
  </Flex>
  </Box>
